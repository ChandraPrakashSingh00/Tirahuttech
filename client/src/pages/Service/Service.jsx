...
import { FaBullhorn, FaUserTie } from "react-icons/fa";
...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      icon: <FaUserTie />,
      color: "#00444b",
      desc: "IT Staff Augmentation, Dedicated Development Teams",
      extra: "Project, • Based • Engagement • Dedicated Teams",
      link: "/service/hr-it-recruitment",
    },
