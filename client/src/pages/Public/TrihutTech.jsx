...
function TrihutTech() {
  ...
  return (
    <div className="w-full min-h-[calc(100vh_-_80px)] bg-[#F4F4F4] font-[Inter]">
      ...
      <section
        className="w-full bg-gradient-to-r from-[#01686d] to-[#01686d]
        ...
        <div className="max-w-xl bg-white rounded-2xl p-8
          ...
          <div className="flex items-center gap-4 justify-center lg:justify-start pt-4">
            ...
            <div className="text-left">
              <h3 className="text-xl font-bold text-gray-900">Chirag Sharma</h3>
              <p className="text-sm text-gray-500">COO, General Manager</p>
            </div>
          </div>
        </div>
      </section>
