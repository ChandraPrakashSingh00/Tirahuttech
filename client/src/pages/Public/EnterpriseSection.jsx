          ...
          <div className="relative max-w-md sm:max-w-lg w-full">
            ...
            >
              ...
              <p className="mt-4 text-[#00444b] text-sm sm:text-base md:text-lg font-medium leading-relaxed">
                I had a project related to weather calculations and environmental <strong>www.hsrif.com</strong> data processing. Tirahut Tech understood the requirements well and developed a structured platform that made complex functionalities easy to use.
              </p>
              ...
              <div className="mt-7 sm:mt-8 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-500">
                    Founder, Research Associate - IIT, Roorkee
                  </p>
                </div>
              </div>
            </div>
